...
var DeviceService = (function () {
    ...
    DeviceService.prototype.cadastra = function (device) {
        if (device._id) {
            return this.http
                .put(this.url + '/' + device._id, JSON.stringify(device), { headers: this.headers })
                .map(function () { return new MensagemCadastro('Device alterado com sucesso', false); });
        }
        else {
            return this.http
                .post(this.url, JSON.stringify(device), { headers: this.headers })
                .map(function () { return new MensagemCadastro('Device incluído com sucesso', true); });
        }
    };
    DeviceService.prototype.lista = function () {
        return this.http
            .get(this.url)
            .map(function (res) { return res.json(); });
    };
    DeviceService.prototype.remove = function (device) {
        return this.http.delete(this.url + '/' + device._id);
    };
    DeviceService.prototype.buscaPorId = function (id) {
        return this.http
            .get(this.url + '/' + id)
            .map(function (res) { return res.json(); });
    };
